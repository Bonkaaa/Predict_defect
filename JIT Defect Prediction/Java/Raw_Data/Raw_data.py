...
df_train = pd.read_csv(r'D:\ML\Finding_defect\Files\Java\train.csv')
df_test = pd.read_csv(r'D:\ML\Finding_defect\Files\Java\test.csv')
...
model = LogisticRegression(solver = 'saga', class_weight='balanced', random_state=42, max_iter=10000, penalty= 'l2', C = 0.01)
